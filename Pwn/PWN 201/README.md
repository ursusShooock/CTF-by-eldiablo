...
Let's go ahead and grab the shellcode that was created in [PWN 101](https://github.com/ursusShooock/CTF-by-eldiablo/tree/main/Pwn/PWN%20101). We can add "\x" to the beginning of each byte in the shellcode by slightly modifying the for loop that was used in [PWN 101](https://github.com/ursusShooock/CTF-by-eldiablo/tree/main/Pwn/PWN%20101).
```sh
